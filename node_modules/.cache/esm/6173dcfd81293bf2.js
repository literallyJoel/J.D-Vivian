let dbAuth;_812‍.w("./mauth.js",[["dbAuth",["dbAuth"],function(v){dbAuth=v}]]);var express = require('express');
...
_812‍.g.console.log(conString);
const db = monk(conString);

db.then(() =>{
    _812‍.g.console.log("Connected to DB", {authSource: 'admin'}, {uri_decode_auth: true});
}).catch((e)=>{
    _812‍.g.console.log(e);
});
...
const server = https.createServer(credentials, app).listen(443, () => _812‍.g.console.log("Listening on HTTPS on port " + app.get('port')));
